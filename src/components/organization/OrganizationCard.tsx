  ...
  return (
    <Paper elevation={2}>
      ...
      <Typography color="#3E3E3E">
        ...
        children and support their essential needs through local soup kitchens.
        Our unwavering mission revolves around simplifying and enhancing the act
        of giving by harnessing the power of Decentralized Finance (DeFi).By
        synergizing blockchain innovation and charitable initiatives, we have
        reimagined the way donations are made and managed. Our visionary
        approach not only ensures the utmost transparency but also empowers
        every donor with a profound sense of impact. Through DeFi, we create an
        ecosystem where each contribution, regardless of its size, becomes a
        pivotal force in shaping a better future for the underprivileged.
      </Typography>
      ...
      <Button fullWidth variant="contained" sx={{ paddingY: 2 }}>
